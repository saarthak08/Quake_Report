...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    public static void JSONData() throws JSONException {
        int i;
        Date date;
...
class Adapter extends RecyclerView.Adapter<Adapter.AdapterCustomViewHolder>
{
    private List<String> mEarthquake[];

    private Context mContext;
    public Adapter(Context context, List<String> cn[])
    {
        mEarthquake=cn;
        mContext=context;
    }
    ...
    public int getMagnitudeColor(String mag)
    {
        ...
        switch(magn)
        {
            ...
            break;
            case 9:
            result=ContextCompat.getColor(mContext, R.color.magnitude9);
            break;
            default:
